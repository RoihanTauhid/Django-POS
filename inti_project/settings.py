"""
Django settings for inti_project project.
...
SECRET_KEY = 'django-insecure-=i05&t(^rgzwhxp39hx-tz0p2@*l6s&hbdam8f3ik$wdiiyh@+'
...
ROOT_URLCONF = 'inti_project.urls'
...
WSGI_APPLICATION = 'inti_project.wsgi.application'
